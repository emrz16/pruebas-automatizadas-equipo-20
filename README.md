...
|Crear nueva etiqueta |Create tag with title and description | [12](https://github.com/emrz16/pruebas-automatizadas-equipo-20/blob/master/estrategias-cypress/cypress/e2e/tag.cy.js)| manual - automatizada|
